  ...
  return (
    <>
      <div className='bg-gray py-24'>
        <div className='grid lg:hidden grid-cols-4 gap-4'>
          <div className='col-span-2 col-start-2'>
            ...
            <ul className='flex justify-center py-8 space-x-4'>
              <li>
        ...
        <div className='container hidden lg:grid lg:grid-cols-12 lg:gap-4 lg:mx-auto'>
